...
import com.tgp.router_core.callback.NavigationCallback;
import com.tgp.router_core.exception.NoRouteFoundException;
import com.tgp.router_core.template.IRouteGroup;
import com.tgp.router_core.template.IRouteRoot;
import com.tgp.router_core.template.IService;
import com.tgp.router_core.utils.ClassUtils;
...
public class TgpRouter {
    private static final String TAG = "TgpRouter";
    private static final String ROUTE_ROOT_PACKAGE = "com.tgp.router_core";
    private static final String SDK_NAME = "TgpRouter";
    private static final String SEPARATOR = "$$";
    private static final String SUFFIX_ROOT = "Root";
    private static Application mContext;

    private static TgpRouter instance;


    public static TgpRouter getInstance() {
        synchronized (TgpRouter.class) {
            if (instance == null) {
                instance = new TgpRouter();
            }
        }
        return instance;
    }
